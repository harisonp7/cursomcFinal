...
public class Produto implements Serializable{
	private static final long serialVersionUID = 1L;
		...
		@JoinTable(name = "PRODUTO_CATEGORIA", 								//nome da tabela
				...
				inverseJoinColumns = @JoinColumn(name = "categoria_id") 	//id da tabela de categoria - outra chave estrangeira
		)																	//Definie quem é a tabela que vai fazer muitos para muitos no banco de dados. 
		private List<Categoria> categorias = new ArrayList<>(); 			//Um produto pode ter várias categorias N para N. 
